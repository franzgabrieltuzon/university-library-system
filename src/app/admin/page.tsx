...
import { Search, FileDown, LogOut } from 'lucide-react';
    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      <div className="flex justify-between items-start">
        ...
        <Button 
          ...
          className="h-12 px-5 text-slate-400 hover:bg-white/5 hover:text-white text-xs font-bold uppercase tracking-widest rounded-xl transition-all flex items-center gap-2"
        >
